...
public class CoDrinkAdapter extends RecyclerView.Adapter<CoDrinkAdapter.RecyclerViewHolder> {


    private List<DataProducts> dataList;
    private List<DataProducts> dataListFiltered;
    private CoDrinkAdapter coDrinkAdapter;
    ...
    public CoDrinkAdapter(List<DataProducts> data, Context context,OnShareClickedListener onShareClickedListener) {
        this.dataList = data;
