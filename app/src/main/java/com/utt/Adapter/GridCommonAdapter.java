...
public class GridCommonAdapter extends RecyclerView.Adapter<GridCommonAdapter.RecyclerViewHolder> {
    ...
    public GridCommonAdapter(List<DataProducts> data, Context context, OnShareClickedListener onShareClickedListener) {
        this.dataList = data;
